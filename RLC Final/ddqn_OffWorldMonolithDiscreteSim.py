...
# create the envronment and can change channel type between depth, RGB and RGBD
...
def create_network():
    ...
    img_input = Input(shape=(240, 320, 4), name='img_input') #must be changed to support channel
...
def train():
    ...
    memory_size = 25000
    window_length = 4
    total_nb_steps = 10000		#modified the number of steps to shorten training duration 
